...
class BlockChain:
    ...
    def check_validity(block, prev_block):
        """
        A ideia é que seja validado se o proximo indice na cadeia do bloco é realmente ele + 1
        :param block:
        :param prev_block:
        :return:
        """
        ...
        if prev_block.index + 1 != block.index:
            return False
        # verifica se o hash do bloco anterior coincide com o previous hash do atual
